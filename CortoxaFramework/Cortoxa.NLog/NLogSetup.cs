...
using Cortoxa.Container.Configuration;

namespace Cortoxa.NLog
{
    public static class NLogSetup
    {
        public static IConfiguration<LoggerComponent> Nlog(this IContainerConfiguration<LoggerComponent> configuration)
        {
            configuration.SetStrategy(new NLogRegistration(configuration.Conteiner));
            return configuration;
//            creator.Create(() => new NLogRegistration());
...
//            return componentRegistrator.Configure();
        }
    }
}